...
class CarsTodoListsControllerTest < ActionController::TestCase
  ...
  test "should create cars_todo_list" do
    assert_difference('CarsTodoList.count') do
      post :create, cars_todo_list: { car_model: @cars_todo_list.car_model, car_owner_email: @cars_todo_list.car_owner_email, car_plate_number: @cars_todo_list.car_plate_number }
    end
  ...
  test "should update cars_todo_list" do
    patch :update, id: @cars_todo_list, cars_todo_list: { car_model: @cars_todo_list.car_model, car_owner_email: @cars_todo_list.car_owner_email, car_plate_number: @cars_todo_list.car_plate_number }
    assert_redirected_to cars_todo_list_path(assigns(:cars_todo_list))
  end
